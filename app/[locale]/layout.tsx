    ...
    <>
      <html className="h-full" dir="ltr" lang={locale} suppressHydrationWarning>
        <head>
          ...
          <meta content="MuscleMap" name="apple-mobile-web-app-title" />
        ...
        <body
          className={cn(
            "flex items-center justify-center min-h-screen w-full max-sm:p-0 max-sm:min-h-full bg-white text-gray-900 antialiased",
            "font-sans",
          )}
